  ...
  <div class="row">
      @foreach($gamesJustIn as $justIn)
          ...
          <div class="col-6 col-lg-3"><img src="{{$justIn->image}}" alt="" class="hotItems img-fluid"><br>Price £{{$justIn->price}}<br><br><a href="{{route('viewgames.show', $justIn->id)}}" class="btn btn-primary" role="button">View Item</a></div>
        {{-- @else
